...
BOW_scatter <- ggplot(data = BOW,aes(x=insitu_temp,y=sat_temp,color=insitu_temp))+
  ...
  scale_x_continuous(limits = c(24.5,31.4),expand=c(0,0),name = "In situ Temperature (°C)")+
  scale_y_continuous(limits = c(24.5,31.4),expand=c(0,0), name = "Satellite Temperature (°C)")+
