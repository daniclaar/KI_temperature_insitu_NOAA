...
region_noEN_meandiff <- data.frame("Vaskess Bay" = 0.37, 
                                   "South Lagoon" = 0.61,
                                   "Lagoon Face" = 0.58,
                                   "North Lagoon" = 0.66,
                                   "North Shore" = 0.44,
...
MMM_NOAAminOffsetnoEN_VB <- MMM_all[6]-region_noEN_meandiff$Vaskess.Bay
MMM_NOAAminOffsetnoEN_SL <- MMM_all[5]-region_noEN_meandiff$South.Lagoon
MMM_NOAAminOffsetnoEN_LF <- MMM_all[2]-region_noEN_meandiff$Lagoon.Face
MMM_NOAAminOffsetnoEN_NL <- MMM_all[3]-region_noEN_meandiff$North.Lagoon
MMM_NOAAminOffsetnoEN_NS <- MMM_all[4]-region_noEN_meandiff$North.Shore
MMM_NOAAminOffsetnoEN_BOW <- MMM_all[1]-region_noEN_meandiff$Bay.of.Wrecks
...
hotspot<-southlagoon_halfwk$temperature_halfwk-MMM_NOAAminOffsetnoEN_SL
...
hotspot<-northlagoon_halfwk$temperature_halfwk-MMM_NOAAminOffsetnoEN_NL
hotspot<-ifelse(hotspot<1,hotspot==0,hotspot)
...
hotspot<-lagoonface_halfwk$temperature_halfwk-MMM_NOAAminOffsetnoEN_LF
hotspot<-ifelse(hotspot<1,hotspot==0,hotspot)
...
hotspot<-northshore_halfwk$temperature_halfwk-MMM_NOAAminOffsetnoEN_NS
hotspot<-ifelse(hotspot<1,hotspot==0,hotspot)
...
hotspot<-bayofwrecks_halfwk$temperature_halfwk-MMM_NOAAminOffsetnoEN_BOW
hotspot<-ifelse(hotspot<1,hotspot==0,hotspot)
...
hotspot<-vaskesbay_halfwk$temperature_halfwk-MMM_NOAAminOffsetnoEN_VB
hotspot<-ifelse(hotspot<1,hotspot==0,hotspot)
...
southlagoon_DHW_minOffsetnoEN <- southlagoon_DHW
northlagoon_DHW_minOffsetnoEN <- northlagoon_DHW
lagoonface_DHW_minOffsetnoEN <- lagoonface_DHW
northshore_DHW_minOffsetnoEN <- northshore_DHW
bayofwrecks_DHW_minOffsetnoEN <- bayofwrecks_DHW
vaskesbay_DHW_minOffsetnoEN <- vaskesbay_DHW

# Save all DHW data to an .RData file
save(southlagoon_DHW_minOffsetnoEN,northlagoon_DHW_minOffsetnoEN,lagoonface_DHW_minOffsetnoEN,northshore_DHW_minOffsetnoEN,bayofwrecks_DHW_minOffsetnoEN,vaskesbay_DHW_minOffsetnoEN,file="data/KI_SB_temp_DHW_NOAAMMM_minOffsetnoEN.RData")
