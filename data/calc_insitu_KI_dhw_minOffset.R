...
region_meandiff <- data.frame("Vaskess Bay" = 0.32, 
                              "South Lagoon" = 0.54,
                              "Lagoon Face" = 0.49,
                              "North Lagoon" = 0.59,
                              "North Shore" = 0.36,
...
MMM_NOAAminOffset_VB <- MMM_all[6]-region_meandiff$Vaskess.Bay
MMM_NOAAminOffset_SL <- MMM_all[5]-region_meandiff$South.Lagoon
MMM_NOAAminOffset_LF <- MMM_all[2]-region_meandiff$Lagoon.Face
MMM_NOAAminOffset_NL <- MMM_all[3]-region_meandiff$North.Lagoon
MMM_NOAAminOffset_NS <- MMM_all[4]-region_meandiff$North.Shore
MMM_NOAAminOffset_BOW <- MMM_all[1]-region_meandiff$Bay.of.Wrecks
...
hotspot<-southlagoon_halfwk$temperature_halfwk-MMM_NOAAminOffset_SL
...
hotspot<-northlagoon_halfwk$temperature_halfwk-MMM_NOAAminOffset_NL
hotspot<-ifelse(hotspot<1,hotspot==0,hotspot)
...
hotspot<-lagoonface_halfwk$temperature_halfwk-MMM_NOAAminOffset_LF
hotspot<-ifelse(hotspot<1,hotspot==0,hotspot)
...
hotspot<-northshore_halfwk$temperature_halfwk-MMM_NOAAminOffset_NS
hotspot<-ifelse(hotspot<1,hotspot==0,hotspot)
...
hotspot<-bayofwrecks_halfwk$temperature_halfwk-MMM_NOAAminOffset_BOW
hotspot<-ifelse(hotspot<1,hotspot==0,hotspot)
...
hotspot<-vaskesbay_halfwk$temperature_halfwk-MMM_NOAAminOffset_VB
hotspot<-ifelse(hotspot<1,hotspot==0,hotspot)
...
southlagoon_DHW_minOffset <- southlagoon_DHW
northlagoon_DHW_minOffset <- northlagoon_DHW
lagoonface_DHW_minOffset <- lagoonface_DHW
northshore_DHW_minOffset <- northshore_DHW
bayofwrecks_DHW_minOffset <- bayofwrecks_DHW
vaskesbay_DHW_minOffset <- vaskesbay_DHW

# Save all DHW data to an .RData file
save(southlagoon_DHW_minOffset,northlagoon_DHW_minOffset,lagoonface_DHW_minOffset,northshore_DHW_minOffset,bayofwrecks_DHW_minOffset,vaskesbay_DHW_minOffset,file="data/KI_SB_temp_DHW_NOAAMMMminOffset.RData")
